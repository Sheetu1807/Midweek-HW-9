...
public class Que8_Stations {
    public static void main(String[] args) {
        // Create a new HashMap object called stations that stores the names of London Underground stations
        // as keys and the lines that pass through those stations as values
